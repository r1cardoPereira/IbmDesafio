		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (!textNome.getText().isEmpty() && !textEndereco.getText().isEmpty()
					...
					// System.out.println("Todos os campos s�o obrigat�rios");
		...
		btnNewButton_3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!textAlterarEndereco.getText().isEmpty()) {
					...
					JOptionPane.showMessageDialog(null, "Endere�o alterado com sucesso! ");
		...
		btnNewButton_5.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if (textAlterarIdProduto.getText().isEmpty()) {
					// System.out.println("Id do produto obrigat�rio!");
					JOptionPane.showMessageDialog(null, "Id do produto obrigat�rio!");
					return;
